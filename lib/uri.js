 ...
 * ```javascript
 *
 * var uri = new URI('unihash:LLNxdByMgALUxS7KjNq6wbfqwQmgqGqfAB?amount=1.2');
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'unihash:') {
    throw new TypeError('Invalid unihash URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid unihash address');
  }
